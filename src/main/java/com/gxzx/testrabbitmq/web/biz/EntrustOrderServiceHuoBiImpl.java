 ...
 */
@Service
public class EntrustOrderServiceHuoBiImpl implements IEntrustOrderService {
    
	private static final Logger logger = LoggerFactory.getLogger(EntrustOrderServiceHuoBiImpl.class);
